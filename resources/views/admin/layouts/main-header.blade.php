                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <a class="profile-user d-flex" href="">
                        ...
                        @if (\Illuminate\Support\Facades\Auth::user()->type == 'supervisor')
                            ...
                            @else
                                <img alt="" src="{{ URL::asset('assets/admin/img/logo_tabrat.png') }}">
                            @endif
                        @else
                            <img alt="" src="{{ URL::asset('assets/admin/img/logo_tabrat.png') }}">
                        @endif
                    ...
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                ...
                                <div class="main-img-user">@if (\Illuminate\Support\Facades\Auth::user()->type == 'supervisor')
                                    @php
                                        $region = Auth::user()->regions;
                                        $region_data = App\Models\admin\Region::where('id', $region)->first();
                                    @endphp
                        ...
                        <a class="dropdown-item" href="{{ url('admin/update_admin_details') }}"><i
                                class="bx bx-user-circle"></i> حسابي </a>
                        <a class="dropdown-item" href="{{ url('admin/update_admin_password') }}"><i
                                class="bx bx-cog"></i> تعديل كلمة المرور </a>
