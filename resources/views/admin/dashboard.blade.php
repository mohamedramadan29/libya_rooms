                    ...
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    @php
                                        $query = \App\Models\admin\FinanialTransaction::with('company_data', 'employe_data')->where('region', $user->regions);
                                            if ($user->branches !== null) {
                                                $query->where('branch', $user->branches);
                                            }
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    ...
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white"> @php echo count(\App\Models\admin\Companies::orderby('id', 'desc')->where('region', $user->regions)->where('branch', $user->branches)->get()) @endphp  </h4>
                                    <a href="{{url('admin/companies')}}" class="mb-0 tx-17 text-white op-7"> مشاهدة
                                        التفاصيل </a>
                                </div>
                            </div>
                    ...
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    @php   $user = \Illuminate\Support\Facades\Auth::user(); @endphp
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white"> @php echo count(\App\Models\admin\Companies::where('market_confirm', '0')->where('region', $user->regions)->where('branch', $user->branches)->orderby('id', 'desc')->get()) @endphp  </h4>
                                    <a href="{{url('admin/companies/market-unconfirmed')}}" class="mb-0 tx-17 text-white op-7"> مشاهدة
                                        التفاصيل </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    @php   $user = \Illuminate\Support\Facades\Auth::user(); @endphp
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white"> @php echo count(\App\Models\admin\Companies::where('market_confirm', '1')->where('region', $user->regions)->where('branch', $user->branches)->get()) @endphp  </h4>
                                    <a href="{{url('admin/companies')}}" class="mb-0 tx-17 text-white op-7"> مشاهدة
                                        التفاصيل </a>
                                </div>
                            </div>
                    ...
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    @php   $user = \Illuminate\Support\Facades\Auth::user(); @endphp
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white"> @php echo count(\App\Models\admin\Companies::where('money_confirm', '0')->where('market_confirm', '1')->where('region', $user->regions)->where('branch', $user->branches)->get()) @endphp  </h4>
                                    <a href="{{url('admin/companies/money-unconfirmed')}}" class="mb-0 tx-17 text-white op-7"> مشاهدة
                                        التفاصيل </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    @php   $user = \Illuminate\Support\Facades\Auth::user(); @endphp
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white"> @php echo count(\App\Models\admin\FinanialTransaction::where('region',$user->regions)->where('branch',$user->branches)->get()) @endphp  </h4>
                                    <a href="{{url('admin/transaction')}}" class="mb-0 tx-17 text-white op-7"> مشاهدة
                                        التفاصيل </a>
                                </div>
                            </div>
