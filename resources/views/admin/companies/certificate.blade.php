...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between no-print">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ اصدار
                    شهادة التوثيق </span>
            </div>
        </div>
    </div>
            ...
            <div class="card" style="background-color:#fff !important;">
                ...
                <div class="card-body print" id="print">
                    ...
                    <div class="main_head no-print">
                        <img style="object-fit: contain;max-width: 50%;margin: auto;display: block;margin-top: 40px;margin-bottom: 30px;"
                            src="{{ asset('assets/admin/certificate/second_head.png') }}" alt="">
                    </div>
                    <div class="content_body">
                        <div>
                            <p> <strong> بناءا علي طلب القيد المؤرخ في </strong> <span class="text1"> </span> <span>
                                </span> <span> / </span>
                                <span> </span>
                                ...
                                <strong> رقم (5) من القانون رقم (7) لسنة ( 2024 م ) بشان السياحة واللوائح والقرارات الصادرة
                                    ...
                                    فقد </strong>
                                <br>
                                <strong> تم القيد بسجلات الغرفه تحت رقم ( </strong> <span class="text2">
                                    {{ $company['id'] }} </span> <strong> ) شعبة رقم ( </strong>
                    ...
                    <div class="body_info">
                        <ul class="list-unstyled listed_info">
                            ...
                            <li><span class="no-print"> نوع النشاط </span>
                                <span> {{ $company['subcategory']['name'] }} </span>
                            </li>
                            <hr>
                        </ul>
                        ...
                        <div class="">
                            <img class="no-print" style="object-fit: contain"
                                src="{{ asset('assets/admin/certificate/head3.png') }}" alt="">
                        ...
                        <div class="first_body">
                            <div>
                                @if ($company['new_market_confirm_date'] == null)
                                    <p class="text4"> <strong class="no-print text4"> حرر بتاريخ : </strong>
                                        {{ $company['first_market_confirm_date'] }} </p>
                                @else
                                    <p class="text4"> <strong class="no-print text4"> حرر بتاريخ : </strong>
                                        {{ $company['new_market_confirm_date'] }} </p>
                                @endif

                            </div>

                            <div>
                                <p class="text5"><strong class="no-print"> تاريخ الصلاحية : </strong>
                                    {{ $expirationDate->format('Y-m-d') }} </p>
                            </div>
                        </div>
                        <div class="no-print">
