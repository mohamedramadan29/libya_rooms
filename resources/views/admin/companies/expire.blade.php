...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الانشطة
                            ...
                            <div class="d-flex align-items-center">
                                <div class="form_box" style="min-width: 30%">
                                    ...
                                    <select class="form-control" name="year" id="year">
                                        ...
                                        @for ($i = now()->year - 10; $i <= now()->year + 10; $i++)
                                            <option value="{{ $i }}"
                                                {{ old('year', request('year')) == $i ? 'selected' : '' }}>
                                                {{ $i }}
                                            </option>
                                        @endfor
                                    </select>
                                ...
                                <div class="form_box" style="min-width: 30%">
                                    ...
                                    <select class="form-control" name="month" id="month">
                                        ...
                                        @for ($i = 1; $i <= 12; $i++)
                                            <option value="{{ $i }}"
                                                {{ old('month', request('month')) == $i ? 'selected' : '' }}>
                                                {{ $i }}</option>
                                        @endfor
                                    </select>
                                </div>
                                ...
                                @foreach ($companies as $company)
                                    <tr>
                                        ...
                                        <td style="color:red">
                                            ...
                                            @else
                                                {{ date('Y-m-d', strtotime($company['expiry_date']))}}
                                            @endif
