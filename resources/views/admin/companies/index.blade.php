...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الشعب
                    المسجلة </span>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                                    ...
                                    <select class="form-control" name="type" id="type">
                                        ...
                                        @foreach ($types as $type)
                                            <option value="{{ $type['id'] }}"
                                                {{ old('type', request('type')) == $type['id'] ? 'selected' : '' }}>
                                                {{ $type['name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <br>
                    <div class="d-flex">
                        <a style="margin:5px" target="_blank" class="btn btn-primary"
                            href="{{ url('admin/company-report') }}">
                            استخراج ملف Pdf </a>
                        <a style="margin:5px" target="_blank" class="btn btn-warning"
                            href="{{ url('admin/company-excel') }}"> استخراج
                            ملف Excel </a>
                    </div>
                                            ...
                                            @else
                                                ...
                                                @if (Auth::user()->type == 'supervisor' && Auth::user()->branches != null && $company['market_confirm'] == 1)
                                                    <a href="{{ url('admin/companies/money_confirm/' . $company['id']) }}"
                                                        class="btn btn-success btn-sm"><i class="fa fa-check"> تأكيد الدفع
                                                        </i>
                                                    </a>
                                                @endif
                                            @endif
