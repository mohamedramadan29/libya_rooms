            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post"
                          action="{{ url('admin/transaction/update/'.$transaction['id']) }}"
                            ...
                            <div class="col-lg-12 col-12">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select required class="form-control select2" name="company_id">
                                        ...
                                        @foreach($companies as $company)
                                            <option @if($transaction['company_id'] == $company['id']) selected
                                ...
                                <div class="form-group ">
                                    ...
                                    <select required class="form-control select2" name="trans_type">
                                        ...
                                        <option @if($transaction['trans_type'] =='قيد جديد') selected
                                                @endif value="قيد جديد"> قيد جديد
                                        </option>
                                        <option @if($transaction['trans_type'] =='تجديد قيد') selected
                                                @endif  value="تجديد قيد"> تجديد قيد
                                        </option>
                                        <option @if($transaction['trans_type'] =='استخراج شهائد') selected
                                                @endif  value="استخراج شهائد"> استخراج شهائد
                                        </option>
                                        <option @if($transaction['trans_type'] =='تصديق المستندات') selected
                                                @endif  value="تصديق المستندات"> تصديق المستندات
                                        </option>
                                        <option @if($transaction['trans_type'] =='ايرادات اخري') selected
                                                @endif  value="ايرادات اخري">ايرادات اخري
                                        </option>
                                ...
                                <div class="form-group ">
                                    ...
                                    <textarea name="notes" class="form-control" id="" cols="30"
                                              rows="5">{{$transaction['notes']}}</textarea>
                                </div>
                            </div>
                        </div>
